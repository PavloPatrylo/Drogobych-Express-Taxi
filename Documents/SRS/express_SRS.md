...
- Помилок при подвійному продажі місць (overoverbooking)
...
- Захист від overoverbooking при конкурентних запитах
- Генерацію розкладу
...
3. Core API створює запис у `BOOKINGS` з `booking_type='PARCEL'`, `source='DRIVER'`, `status='BOARDED'`, `passengers_count = 0`, `passenger_id = NULL`
4. Бот підтверджує: «Посилку записано»
